        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannerPicture = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true),
                    DeliveryAddress_HomeNumber = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    DeliveryAddress_StreetName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    DeliveryAddress_District = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    DeliveryAddress_CityName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    DeliveryAddress_PostalCode = table.Column<uint>(type: "int unsigned", maxLength: 100, nullable: true),
                    OrganizationName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    BusinessEmail = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayImage = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true),
                    ...
                    PercentDiscount = table.Column<double>(type: "double", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    DateTimeOrdered = table.Column<DateTime>(type: "datetime(6)", nullable: false),
